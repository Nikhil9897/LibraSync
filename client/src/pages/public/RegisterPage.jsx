...
const RegisterPage = () => {
    ...
    return (
        <div className="min-h-[80vh] flex items-center justify-center bg-[#f8fafc] px-4 py-12 relative overflow-hidden" >
            {/* Background elements */}
            <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-[#d4a853]/10 rounded-full blur-3xl mix-blend-multiply"></div>
            <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-[#0d5959]/10 rounded-full blur-3xl mix-blend-multiply"></div>
            ...
            <div className="max-w-md w-full relative z-10">
                <div className="text-center mb-10 flex flex-col items-center">
                    ...
                    <h2 className="text-3xl  font-bold text-[#1a1f36] dark:text-white">Create an Account</h2>
                    <p className="text-slate-500 mt-2 font-medium">Join Librasync to start borrowing books.</p>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-900 rounded-3xl shadow-xl shadow-[#0d5959]/5 border dark:border-slate-700 border-slate-100 p-8 sm:p-10">
                    ...
                    <div className="relative mb-8">
                        ...
                        <div className="relative flex justify-center text-xs"><span className="bg-slate-50 dark:bg-slate-900 px-4 text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest">or sign up with email</span></div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3.5 bg-[#0d5959] text-white font-bold rounded-xl hover:bg-[#0a4747] transition-all shadow-md shadow-[#0d5959]/20 disabled:opacity-50 mt-2"
                        >
                    ...
                    <div className="mt-8 text-center text-sm text-slate-500 font-medium">
                        ...
                        <Link to="/login" className="text-[#0d5959] font-bold hover:text-[#d4a853] transition-colors">
                            Log in
                        </Link>
                    </div>
                </div>
